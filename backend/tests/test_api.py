...
VALIDATION_CASES = [
    ...
    ("GET", "/api/jd/trend?days=6", None, 422),
    ("GET", "/api/jd/market-trend?keyword=A&years=5", None, 422),
...
BOUNDARY_CASES = [
    ...
    ("GET", "/api/jd/trend?days=90", None),
    ("GET", "/api/jd/market-trend?keyword=Backend%20Engineer&years=10", None),
    ("GET", "/api/jd/42", None),
    ("DELETE", "/api/jd/42", None),
    (
        "GET",
